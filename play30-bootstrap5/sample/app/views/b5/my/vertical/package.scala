...
package object vertical {
  ...
  class MyVerticalFieldConstructor extends vertical.VerticalFieldConstructor(isCustom = true, withFeedbackTooltip = true) {
    ...
    override def apply(fieldInfo: B5FieldInfo, inputHtml: Html)(implicit msgsProv: MessagesProvider) = bsFieldConstructor(fieldInfo, inputHtml)(this, msgsProv)
   ...
   */
  val fieldConstructor: B5FieldConstructor = fieldConstructorSpecific
  ...
  def form(action: Call, args: (Symbol, Any)*)(body: MyVerticalFieldConstructor => Html) =
    views.html.b5.form(action, args: _*)(body(fieldConstructorSpecific))(fieldConstructorSpecific)
  def formCSRF(action: Call, args: (Symbol, Any)*)(body: MyVerticalFieldConstructor => Html)(implicit request: RequestHeader) =
    views.html.b5.formCSRF(action, inner(args): _*)(body(fieldConstructorSpecific))(fieldConstructorSpecific, request)
}