...
class FormsSpec extends Specification {
  ...
  def fooFormBody(args: (Symbol, Any)*)(fc: b5.b5FieldConstructor) = b5.form(fooCall, args*)(Html(testContentString))(fc).body
  ...
  "@form" should {
    ...
    "add default class for each field constructor" in {
      ...
      fooFormBody()(using cfc) must contain("class=\"form-clear")
    }
